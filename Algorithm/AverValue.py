...
# predict_type = 1
# paramter = 5
def Predict_Main(date_start = "2007-1-1",date_end = "2007-1-20",predict_type = 1,paramter = 5):
    date_predict = []
    AverTemper_predict = []
    AverPress_predict = []
    AverSPress_predict = []
    ...
    return PredictList(DateAmend, PowerLoadMax_real, PowerLoadMax_predict, MAPE)
